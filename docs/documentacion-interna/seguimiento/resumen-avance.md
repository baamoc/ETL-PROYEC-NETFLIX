...
- El equipo ya completo y valido los pipelines `01`, `02`, `03` y `04`.
...
| `05_ETL_DIM_PAIS.hpl` | Pendiente | Requiere separar paises multiples |
...
2. Mantener primero el bloque de dimensiones estable antes de pasar a hechos.
